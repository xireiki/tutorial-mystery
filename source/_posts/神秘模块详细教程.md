...
### 本机使用
打开**/data/adb/sfm/src/baseConfig.hjson**，将 **auto_detect_interface** 从 `true` 改为 `false`，这个选项直接搜索即可。
...
在 **auto_detect_interface** 下增加一行 **default_interface**，值就是你在第二步查的网卡名，像这样
